...
public class MenuController {
    ...
    private final MenuPresentationService menuPresentationService;
    ...
    @PatchMapping("/{menuName}/stock")
    public ResponseEntity<Void> updateStock(@PathVariable("menuName") String menuName, @RequestBody java.util.Map<String, Integer> request) {
        menuCoreService.updateStock(menuName, request.get("stock"));
        return ResponseEntity.ok().build();
    }
